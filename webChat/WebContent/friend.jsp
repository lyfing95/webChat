        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
            <li class="am-dropdown" data-am-dropdown>
                <a class="am-dropdown-toggle" data-am-dropdown-toggle href="javascript:;">
                    ${loginUser.nickname }<span class="am-icon-caret-down"></span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="admin-content">
        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
						...
						<%
						   if(request.getAttribute("notfriendList")!=null)
						   {
							   ...
							   for(int i =0;i<notfriendList.size();i++){
								   Chatuser user=notfriendList.get(i);
						%>
								<tr>
									<td><%=user.getId() %></td>
									...
									<td><a href="chatUser/addfriend.do?friendid=<%=user.getId() %>">加好友</a></td>
								</tr> 	
						<% }  } %>							
						</tbody>
					</table>
				...
				<div class="am-comment-bd"> <p>你好，交个朋友吧</p></div></div></li>
